...
def test_drawing_studio_screen_is_translated_in_every_language():
    keys = (
        ...
        "drawing_studio.ga.component_geometry",
        "drawing_studio.ga.position_x",
        "drawing_studio.ga.position_y",
        "drawing_studio.ga.position_z",
        "drawing_studio.ga.invalid_component_geometry",
        "drawing_studio.ga.outside_envelope",
        ...
        "drawing_studio.connections.component_a",
        "drawing_studio.connections.component_b",
        "drawing_studio.connections.connection_type",
        "drawing_studio.connections.fastener_type",
        "drawing_studio.connections.quantity",
        "drawing_studio.connections.note",
